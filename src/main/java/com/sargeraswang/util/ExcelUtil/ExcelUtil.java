...
/**
 * The <code>ExcelUtil</code> 与 {@link com.sargeraswang.util.ExcelUtil.ExcelCell}搭配使用
 *
...
public class ExcelUtil {
    ...
    private static int setCellValue(HSSFCell cell,Object value,String pattern,int cellNum,Field field,HSSFRow row){
        ...
        if (value instanceof Integer) {
            ...
            String empty = "";
            if(field != null) {
                com.sargeraswang.util.ExcelUtil.ExcelCell anno = field.getAnnotation(com.sargeraswang.util.ExcelUtil.ExcelCell.class);
                if (anno != null) {
    ...
    public static <T> Collection<T> importExcel(Class<T> clazz, InputStream inputStream,
        ...
        try {
            List<com.sargeraswang.util.ExcelUtil.ExcelLog> logList = new ArrayList<>();
            // Map<title,index>
                        ...
                        if (field.getType().isArray()) {
                            ...
                            if (isBlank(errMsg)) {
                                ...
                                if (field.getType().equals(Date.class)
                                    ...
                                    com.sargeraswang.util.ExcelUtil.ExcelCell annoCell = field.getAnnotation(com.sargeraswang.util.ExcelUtil.ExcelCell.class);
    ...
    private static List<FieldForSortting> sortFieldByAnno(Class<?> clazz) {
        ...
        for (Field field : fieldsArr) {
            com.sargeraswang.util.ExcelUtil.ExcelCell ec = field.getAnnotation(ExcelCell.class);
            if (ec == null) {
